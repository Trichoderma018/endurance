        ...
        <div className='proyectos-container'>
            <div className='proyectos-tabla-container'>
                ...
                <form onSubmit={handleSubmit}>
                    <select className='selectsEx' value={userExpediente} onChange={e => setUserExpediente(e.target.value)} required>
                    ...
                    <select className='selectsEx' value={rolExpediente} onChange={e => setRolExpediente(e.target.value)} required>
                    ...
                    <select className='selectsEx' value={activoExpediente} onChange={e => setActivoExpediente(e.target.value)} required>
                        <option value="">Estado</option>
                        <option value="inactivo">Inactivo</option>
                        <option value="activo">Activo</option>
                    </select>

                    <select className='selectsEx' value={generoExpediente} onChange={e => setGeneroExpediente(e.target.value)} required>
                    ...
                    <select className='selectsEx' value={sedeExpediente} onChange={e => setSedeExpediente(e.target.value)} required>
                    ...
                    <input className='selectsEx' type="text" value={comentario1Expediente} onChange={e => setComentario1Expediente(e.target.value)} placeholder="Comentario °1" />
                    <input className='selectsEx' type="text" value={comentario2Expediente} onChange={e => setComentario2Expediente(e.target.value)} placeholder="Comentario °2" />
                    <input className='selectsEx' type="text" value={comentario3Expediente} onChange={e => setComentario3Expediente(e.target.value)} placeholder="Comentario °3" />
