...
class IsAdmin(BasePermission):
    ...
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.auth_group.filter(name='Admin').exists()

class IsStaff(BasePermission):
    """Permite acceso a usuarios con rol Admin o Staff"""
    def has_permission(self, request, view):
        return request.user.is_authenticated and request.auth_group.filter(name__in=['Admin', 'Staff']).exists()
